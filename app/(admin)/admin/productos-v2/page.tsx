...
// de tarjetas.
//
// Vive en RUTA PROPIA (`-v2`) mientras convive con la pantalla vieja, y hereda
// `/admin/productos` al retirarse aquélla. Mismo camino que `clientes-v2`.
//
...
// parámetro, así que ningún redirect lo atiende: los `admin:cmdk-recents`
// congelados en el navegador de cada operador van a seleccionar en vez de editar.
// Es aceptable —seleccionar es menos destructivo que abrir un formulario— pero
// hay que VERLO en el gate con un recent real, no suponerlo.
//
...
export default function ProductosV2Page() {
  return <Suspense fallback={null}><ProductosV2 /></Suspense>;
}

function ProductosV2() {
