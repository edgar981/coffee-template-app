    ...
    return (
      <div className="text-center">
        ...
        {/* PALETA-MIGRAR-TEXTO-SOBRE-SUPERFICIE-1: texto directo sobre `--sf-superficie` migrado
            al par `var(--sf-sobre-superficie[-suave],<token de hoy>)` (§ TEMAS-P6-FAMILIAS-1). El
            número de orden (fallback `--sf-acento-texto`) migró en PALETA-MIGRAR-ACENTO-TINTA-1
            (§ PALETA-ACENTO-TINTA-SOBRE-SUPERFICIE-1, DECISIONS.md) -- este `techo` es uno de los
            TRES sitios que sólo se ven cuando el sondeo AGOTA su techo (`TECHO_SONDEO_MS`, § el
