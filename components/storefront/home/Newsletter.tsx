    ...
    <section className="py-16 bg-[var(--sf-superficie)]">
        <div className="max-w-2xl mx-auto px-4 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            <Coffee className="w-8 h-8 text-[var(--sf-acento)] mx-auto mb-4" />
            ...
            <form className="flex gap-3 max-w-sm mx-auto" onSubmit={e => e.preventDefault()}>
              ...
              <button type="submit" className="bg-[var(--sf-acento)] hover:bg-[var(--sf-acento-3)] text-white font-medium px-6 py-3 rounded-full text-sm transition-colors shrink-0">Suscribir</button>
            </form>
          </motion.div>
        </div>
      </section>
