...
// (ONBOARDING-APLICAR-PRESET-SCRIPT-1): afirmaba que `subscriptionCTA` seguía SIN slot de
...
// `CORTE-COMENTARIOS-VENCIDOS-1` ya cerró (en otra rama) para este mismo párrafo.
// `featured`/`trustBadges` ni siquiera son `SeccionKey` (son bandas ESTRUCTURALES sin
