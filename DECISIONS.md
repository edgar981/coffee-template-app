...
→ **208/208**. Cero rojo en los dos carriles — el diff no toca código de producto ni ningún test: es
un solo archivo, esta corrección en `DECISIONS.md`. El 1201 no es el 1200 que cerraba
`WOMPI-API-DIRECTA-CIERRE-1`: entre ese asiento y éste se mergeó `GUARDA-GIT-PROHIBIDO-1` (commit
`7ccb49b`, ver `git log --oneline`), que sumó un test — deriva ajena a este diff, no drift suyo.
